...
int main(int argc, char **argv){
  ...
  if (study_params_ok == 0) {
	...
	while ( read >= 0  ) {
	  ...
	  // frees reason_out pointer
	  free(reason_out); reason_out = NULL;
	  // frees policy variables
...
/* 		strcat( *ptr_reason, pid_invalid ); */

/* 		(*in)++; */
/* 	  } */
/* 	  // policy status date is null */
